...
local colors = require("onechad.colors")
...
function M.setup(config)
  ...
  theme.base = {
    ...
    Search = { bg = c.bg_darker, fg = c.gold }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
    ...
    Operator = { fg = c.blue2 }, -- "sizeof", "+", "*", etc.
  ...
  theme.plugins = {
    ...
    TSOperator = { fg = c.blue2 }, -- For any operator: `+`, but also `->` and `*` in C.
    ...
    TSPunctBracket = { fg = c.magenta }, -- For brackets and parens.
    ...
    TelescopeBorder = { fg = c.border_highlight, bg = c.bg_darker },
    TelescopePreviewBorder = { fg = c.border_highlight, bg = c.bg_darker },
    TelescopeNormal = { bg = c.bg_darker },
    TelescopePreviewNormal = { bg = c.bg_darker },
    ...
    LspSagaHoverBorder = { fg = c.border_highlight, bg = c.bg_float },
