local hsluv = require("onechad.hsluv")
...
-- local ns = vim.api.nvim_create_namespace("onechad")
...
function util.debug(colors)
  colors = colors or require("onechad.colors")
  -- Dump unused colors
...
function util.onColorScheme()
  if vim.g.colors_name ~= "onechad" then
...
function util.autocmds(config)
  vim.cmd([[augroup TokyoNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorScheme * lua require("onechad.util").onColorScheme()]])
  if config.dev then
    vim.cmd([[  autocmd BufWritePost */lua/onechad/** nested colorscheme onechad]])
  end
